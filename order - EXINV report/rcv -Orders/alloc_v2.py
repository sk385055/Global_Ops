...
def allocation(site,ocp_name,date_str):
    ...
    #file_wb = r'workbench_data_eumocp_20240617_v2.csv'
    if site =='enn':
        file='enn'
...
#         file_en = ['openpo_jab_atm_v2_'+date_str+'.csv', 'openpo_jab_sco_v2_'+date_str+'.csv']
    ...
    out.to_csv(r'\\wtc1501cifs.prod.local\ORGSHARE\TEAMS\ERP Shared Folder\NCR Atleos\Atleos Operations Planning\Production\workbench\snd\wb_' + file + '_allocation_' + date_str + '.zip', compression={'method': 'zip', 'archive_name': 'workbench_po.csv'},index=False)
